...
date: "2022-06-01"
preview: "React CSS-in-JS 시스템을 만들어봅시다."
...
이 포스트는 styled-components를 리버스 엔지니어링 하면서 얻은 지식을 사용해 간단한 CSS-in-JS 시스템을 만들어보는 내용이다.
...
<figure><img src="https://media.makeameme.org/created/single-page-application.jpg" alt="SPA EVERYWHERE" /></figure>
...
<figure>
  <img src="https://miro.medium.com/max/1400/1*ZktMuw3JEZFdXVdtyCwTlA.png" />
